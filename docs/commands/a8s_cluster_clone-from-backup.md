...
POST /api/namespaces/{namespace}/clusters/clone-from-backup

## Usage

```text
a8s cluster clone-from-backup [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/namespaces/{namespace}/clusters/clone-from-backup`
