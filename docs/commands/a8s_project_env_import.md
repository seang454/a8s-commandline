# a8s project env import

POST /api/v1/projects/{projectId}/environment/import

## Usage

```text
a8s project env import <project-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/projects/{projectId}/environment/import`
