# a8s database verify-password

POST /api/v1/database-deployments/{deploymentId}/verify-password

## Usage

```text
a8s database verify-password <deployment-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/database-deployments/{deploymentId}/verify-password`
