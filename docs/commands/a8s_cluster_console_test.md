# a8s cluster console test

POST /api/namespaces/{namespace}/clusters/{id}/console/test

## Usage

```text
a8s cluster console test <cluster-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/namespaces/{namespace}/clusters/{id}/console/test`
