# a8s microservice domains update

PATCH /api/v1/projects/microservices/{projectId}/domains

## Usage

```text
a8s microservice domains update <project-id> [flags]
```
...
- `method`: `PATCH`
- `endpoint`: `/api/v1/projects/microservices/{projectId}/domains`
