# a8s database clone-from-backup

POST /api/v1/database-deployments/clone-from-backup

## Usage

```text
a8s database clone-from-backup [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/database-deployments/clone-from-backup`
