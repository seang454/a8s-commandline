# a8s defectdojo token sync

PUT /api/v1/projects/{projectId}/defectdojo/token

## Usage

```text
a8s defectdojo token sync <project-id> [flags]
```
...
- `method`: `PUT`
- `endpoint`: `/api/v1/projects/{projectId}/defectdojo/token`
- `controller`: `ProjectDefectDojoController`
