# a8s microservice delete

DELETE /api/v1/projects/microservices/{projectId}

## Usage

```text
a8s microservice delete <project-id> [flags]
```
...
- `method`: `DELETE`
- `endpoint`: `/api/v1/projects/microservices/{projectId}`
