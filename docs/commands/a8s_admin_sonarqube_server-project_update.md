# a8s admin sonarqube server-project update

PATCH /api/v1/admin/sonarqube/server-projects/{projectKey}

## Usage

```text
a8s admin sonarqube server-project update <project-key> [flags]
```
