...
```text
a8s project webhook rotate <project-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/projects/{projectId}/webhook/rotate`
- `controller`: `ProjectWebhookController`
