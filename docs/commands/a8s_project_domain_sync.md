# a8s project domain sync

POST /api/v1/projects/{projectId}/domain/sync

## Usage

```text
a8s project domain sync <project-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/projects/{projectId}/domain/sync`
