# a8s database backup settings set

PATCH /api/v1/database-deployments/{deploymentId}/backup

## Usage

```text
a8s database backup settings set <deployment-id> [flags]
```
...
- `method`: `PATCH`
- `endpoint`: `/api/v1/database-deployments/{deploymentId}/backup`
