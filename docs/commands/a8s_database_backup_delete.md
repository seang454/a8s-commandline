# a8s database backup delete

DELETE /api/v1/database-deployments/{deploymentId}/backup/runs/{runId}

## Usage

```text
a8s database backup delete <deployment-id> <run-id> [flags]
```
...
- `method`: `DELETE`
- `endpoint`: `/api/v1/database-deployments/{deploymentId}/backup/runs/{runId}`
