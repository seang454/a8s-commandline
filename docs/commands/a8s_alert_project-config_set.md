# a8s alert project-config set

PUT /api/v1/alerts/projects/{projectId}/config

## Usage

```text
a8s alert project-config set <project-id> [flags]
```
...
- `method`: `PUT`
- `endpoint`: `/api/v1/alerts/projects/{projectId}/config`
