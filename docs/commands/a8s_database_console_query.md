# a8s database console query

POST /api/v1/database-deployments/{deploymentId}/console/query

## Usage

```text
a8s database console query <deployment-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/database-deployments/{deploymentId}/console/query`
