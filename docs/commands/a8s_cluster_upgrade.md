...
POST /api/namespaces/{namespace}/clusters/{id}/upgrade-version

## Usage

```text
a8s cluster upgrade <cluster-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/namespaces/{namespace}/clusters/{id}/upgrade-version`
