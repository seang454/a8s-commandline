# a8s database settings update

PATCH /api/v1/database-deployments/{deploymentId}/settings

## Usage

```text
a8s database settings update <deployment-id> [flags]
```
...
- `method`: `PATCH`
- `endpoint`: `/api/v1/database-deployments/{deploymentId}/settings`
