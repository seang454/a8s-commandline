# a8s database backup restore cancel

POST /api/v1/database-deployments/{deploymentId}/backup/runs/{runId}/restore/cancel

## Usage

```text
a8s database backup restore cancel <deployment-id> <run-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/database-deployments/{deploymentId}/backup/runs/{runId}/restore/cancel`
