# a8s microservice rollback

POST /api/v1/projects/microservices/{projectId}/rollback

## Usage

```text
a8s microservice rollback <project-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/projects/microservices/{projectId}/rollback`
