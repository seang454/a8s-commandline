# a8s admin sonarqube server-project create

POST /api/v1/admin/sonarqube/server-projects

## Usage

```text
a8s admin sonarqube server-project create [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/admin/sonarqube/server-projects`
