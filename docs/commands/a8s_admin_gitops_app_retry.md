# a8s admin gitops app retry

POST /api/v1/admin/gitops/apps/{appId}/retry

## Usage

```text
a8s admin gitops app retry <app-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/admin/gitops/apps/{appId}/retry`
