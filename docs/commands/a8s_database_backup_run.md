# a8s database backup run

POST /api/v1/database-deployments/{deploymentId}/backup/run

## Usage

```text
a8s database backup run <deployment-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/database-deployments/{deploymentId}/backup/run`
