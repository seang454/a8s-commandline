# a8s microservice env set

PUT /api/v1/projects/microservices/{projectId}/services/{serviceId}/environment

## Usage

```text
a8s microservice env set <project-id> <service-id> [flags]
```
