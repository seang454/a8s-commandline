# a8s cluster settings update

PATCH /api/namespaces/{namespace}/clusters/{id}/settings

## Usage

```text
a8s cluster settings update <cluster-id> [flags]
```
...
- `method`: `PATCH`
- `endpoint`: `/api/namespaces/{namespace}/clusters/{id}/settings`
