# a8s microservice apply

PUT /api/v1/projects/microservices/{projectId}/canvas

## Usage

```text
a8s microservice apply <project-id> [flags]
```
...
- `method`: `PUT`
- `endpoint`: `/api/v1/projects/microservices/{projectId}/canvas`
