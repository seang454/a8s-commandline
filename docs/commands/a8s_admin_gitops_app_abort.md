# a8s admin gitops app abort

POST /api/v1/admin/gitops/apps/{appId}/abort

## Usage

```text
a8s admin gitops app abort <app-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/admin/gitops/apps/{appId}/abort`
