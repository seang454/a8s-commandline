# a8s database restart

POST /api/v1/database-deployments/{deploymentId}/restart

## Usage

```text
a8s database restart <deployment-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/database-deployments/{deploymentId}/restart`
