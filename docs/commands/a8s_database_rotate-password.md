# a8s database rotate-password

POST /api/v1/database-deployments/{deploymentId}/rotate-password

## Usage

```text
a8s database rotate-password <deployment-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/database-deployments/{deploymentId}/rotate-password`
