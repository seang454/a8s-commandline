# a8s benchmark delete

DELETE /api/v1/projects/live/{projectId}/benchmark/runs/{runId}

## Usage

```text
a8s benchmark delete <project-id> <run-id> [flags]
```
...
- `method`: `DELETE`
- `endpoint`: `/api/v1/projects/live/{projectId}/benchmark/runs/{runId}`
