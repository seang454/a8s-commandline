# a8s microservice webhook update

POST /api/v1/projects/microservices/{projectId}/webhook

## Usage

```text
a8s microservice webhook update <project-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/projects/microservices/{projectId}/webhook`
