# a8s cluster console query

POST /api/namespaces/{namespace}/clusters/{id}/console/query

## Usage

```text
a8s cluster console query <cluster-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/namespaces/{namespace}/clusters/{id}/console/query`
