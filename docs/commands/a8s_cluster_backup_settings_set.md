# a8s cluster backup settings set

PATCH /api/namespaces/{namespace}/cluster-deployments/{releaseName}/backup

## Usage

```text
a8s cluster backup settings set <release-name> [flags]
```
...
- `method`: `PATCH`
- `endpoint`: `/api/namespaces/{namespace}/cluster-deployments/{releaseName}/backup`
