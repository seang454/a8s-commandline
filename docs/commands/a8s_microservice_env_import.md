# a8s microservice env import

POST /api/v1/projects/microservices/{projectId}/services/{serviceId}/environment/import

## Usage

```text
a8s microservice env import <project-id> <service-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/projects/microservices/{projectId}/services/{serviceId}/environment/import`
- `controller`: `MicroserviceProjectController`
