# a8s database upgrade

POST /api/v1/database-deployments/{deploymentId}/upgrade-version

## Usage

```text
a8s database upgrade <deployment-id> [flags]
```
...
- `method`: `POST`
- `endpoint`: `/api/v1/database-deployments/{deploymentId}/upgrade-version`
