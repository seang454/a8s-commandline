# a8s admin cluster quota delete

DELETE /api/v1/admin/clusters/kubernetes/{alias}/quotas/{namespace}

## Usage

```text
a8s admin cluster quota delete <alias> <namespace> [flags]
```
...
- `method`: `DELETE`
- `endpoint`: `/api/v1/admin/clusters/kubernetes/{alias}/quotas/{namespace}`
