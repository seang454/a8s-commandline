# a8s admin sonarqube server-project delete

DELETE /api/v1/admin/sonarqube/server-projects/{projectKey}

## Usage

```text
a8s admin sonarqube server-project delete <project-key> [flags]
```
